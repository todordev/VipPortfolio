    ...
    <div class="row-fluid">
        ...
        <div class="span3">
           <?php if ($this->params->get("image_linkable") OR !empty($this->modal) ) {?>
               <a href="<?php echo $this->imagesUri .$item->image;?>" class="<?php echo $this->modalClass;?>" data-lightbox-gallery="com-list-nivo-gallery<?php echo $item->id;?>">
           <?php }?>
            ...
            <div class="itp-vp-extra-image">
             ...
             if (isset($this->extraImages[$item->id]) AND !empty($this->extraImages[$item->id])){
                 ...
                 foreach($this->extraImages[$item->id] as $eImage){?>
                    ...
                    <a href="<?php echo $this->imagesUri .$eImage['image'];?>" data-lightbox-gallery="com-list-nivo-gallery<?php echo $item->id;?>" class="<?php echo $this->modalClass;?>">
                        <img
