...
<div class="itp-vp-limage-box">
   <?php if ($this->params->get("lLinkable") OR ($this->hasModal) ) {?>
       <a href="media/vipportfolio/<?php echo $this->item->image;?>" rel="lightbox-item<?php echo $this->item->id;?>"  >
   <?php }?>
	...
	<div class="itp-vp-extra-image">
     ...
     if (isset($this->extraImages[$this->item->id]) AND !empty($this->extraImages[$this->item->id])){
         ...
         foreach($this->extraImages[$this->item->id] as $eImage){?>
            ...
            <a href="media/vipportfolio/<?php echo $eImage['name'];?>" rel="lightbox-item<?php echo $this->item->id;?>" >
                <img
                width="48" height="48" 
